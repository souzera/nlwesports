  ...
  return (
      ...
      <div className='grid grid-cols-6 gap-6 mt-16  '>
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 right-0 left-0 '>
            ...
            <span className='text-zinc-300 text-sm block'>1 anuncios</span>
          </div>
        </a>
    ...
    <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg overflow-hidden mt-8'>
      <div className='bg-[#2A2634] px-8 py-6 rounded-t-lg flex justify-between items-center'>
        ...
        <button className='py-3 px-4 bg-violet-500 hover:bg-violet-600 text-white font-bold rounded flex items-center gap-3'>
